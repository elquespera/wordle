...
var es = ['qwertyuiop', 'asdfghjkl', 'zxcvbnm'];
var ru = ['йцукенгшщзхъ', 'фывапролджэ', 'ячсмитьбюё'];
...
var Keyboard = /*#__PURE__*/function () {
  function Keyboard() {
    ...
    this["switch"](en); //Add keypress event listener
  ...
  _createClass(Keyboard, [{
    ...
    value: function _switch() {
      ...
      var layout = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : en;
      ...
      layout.forEach(function (row, ind) {
...
/******/ })()
;
//# sourceMappingURL=bundle.9c816c52e464f1facb7f.js.map