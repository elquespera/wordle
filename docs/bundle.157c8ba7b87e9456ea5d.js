...
var Puzzle = /*#__PURE__*/function () {
  function Puzzle() {
    ...
    document.querySelector('#puzzle').replaceChildren(puzzleFrag); // Attempt to retrieve stored statistics

    var storedStats;

    try {
      storedStats = JSON.parse(_storage__WEBPACK_IMPORTED_MODULE_3__.getItem(STATS_KEY));
    } catch (_unused) {
      storedStats = this._stats;
    }

    if (storedStats) {
      if (storedStats.played && storedStats.dist) this._stats = storedStats;
    }
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.t0 = key;
                _context4.next = _context4.t0 === 'enter' ? 4 : _context4.t0 === 'backspace' ? 17 : 19;
                break;
...
/******/ })()
;
//# sourceMappingURL=bundle.157c8ba7b87e9456ea5d.js.map