...
var switchLanguage = function switchLanguage() {
  ...
  modalPages.forEach(function (pName) {
    ...
    switch (pName) {
      case 'help':
        ...
        var gitHubLink = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.newEl)('a', '', 'icon-btn github-btn');
        gitHubLink.href = "https://github.com/elquespera/wordle";
        gitHubLink.title = 'GitHub repo';
        paneFrag.append((0,_utils__WEBPACK_IMPORTED_MODULE_0__.newEl)('div', '', 'hr'), (0,_utils__WEBPACK_IMPORTED_MODULE_0__.newEl)('h4', layout.help.enjoy), gitHubLink);
        break;
      ...
      case 'settings':
        {
          ...
          var checkTheme = function checkTheme(checkbox) {
            if (_storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem(checkbox.id)) {
  ...
  _storage_js__WEBPACK_IMPORTED_MODULE_5__.setItem(LANG_KEY, layout.locale);
...
var initLanguage = function initLanguage() {
  var userLanguage = function userLanguage() {
    ...
    return ((_navigator = navigator) === null || _navigator === void 0 ? void 0 : (_navigator$language = _navigator.language) === null || _navigator$language === void 0 ? void 0 : _navigator$language.slice(0, 2)) || 'en';
  };

  var locale = _storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem(LANG_KEY);
  currentLayout = _translations_json__WEBPACK_IMPORTED_MODULE_4__[locale] || _translations_json__WEBPACK_IMPORTED_MODULE_4__[userLanguage()] || _translations_json__WEBPACK_IMPORTED_MODULE_4__.en;
...
/* harmony import */ var _assets_words_words_en_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./assets/words/words-en.json */ "./src/assets/words/words-en.json");
/* harmony import */ var _assets_words_words_es_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./assets/words/words-es.json */ "./src/assets/words/words-es.json");
/* harmony import */ var _assets_words_words_ru_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./assets/words/words-ru.json */ "./src/assets/words/words-ru.json");
...
var words = {
  en: _assets_words_words_en_json__WEBPACK_IMPORTED_MODULE_4__,
  es: _assets_words_words_es_json__WEBPACK_IMPORTED_MODULE_5__,
  ru: _assets_words_words_ru_json__WEBPACK_IMPORTED_MODULE_6__
};
var STATS_KEY = 'stats';
var SOLUTION_KEY = 'solution';
var PUZZLE_KEY = 'puzzle';
var wordLength = 5;
var puzzleLength = 6;
...
var Puzzle = /*#__PURE__*/function () {
  function Puzzle() {
    ...
    document.querySelector('#puzzle').replaceChildren(puzzleFrag); // Retrieve stored statistics

    var storedStats = _storage__WEBPACK_IMPORTED_MODULE_3__.getItem(STATS_KEY);
  ...
  _createClass(Puzzle, [{
    key: "checkStoredGame",
    value: function () {
      var _checkStoredGame = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var storedSolution, storedPuzzle, i;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                // Retrieve store puzzle state
                storedSolution = _storage__WEBPACK_IMPORTED_MODULE_3__.getItem(SOLUTION_KEY);
                storedPuzzle = _storage__WEBPACK_IMPORTED_MODULE_3__.getItem(PUZZLE_KEY);

                if (!(storedSolution && storedSolution.toString().length === wordLength && storedPuzzle && Array.isArray(storedPuzzle))) {
                  _context.next = 16;
                  break;
                }
              ...
              case 7:
                if (!(i < storedPuzzle.length)) {
                  _context.next = 13;
                  break;
                }

                _context.next = 10;
                return this.checkLetters(i, i === storedPuzzle.length - 1);
      ...
      function checkStoredGame() {
        return _checkStoredGame.apply(this, arguments);
      }
    ...
    set: function set(word) {
      this._solution = word;
      console.log(word);
      (0,_utils__WEBPACK_IMPORTED_MODULE_7__.$)('#answer').innerHTML = word;
    ...
    key: "storeStats",
    value: function storeStats() {
      _storage__WEBPACK_IMPORTED_MODULE_3__.setItem(STATS_KEY, this.stats);
    }
  }, {
    key: "addGame",
    ...
    value: function reset() {
      ...
      _storage__WEBPACK_IMPORTED_MODULE_3__.removeItem(SOLUTION_KEY);
      _storage__WEBPACK_IMPORTED_MODULE_3__.removeItem(PUZZLE_KEY);
    }
  }, {
    key: "update",
    ...
    key: "checkLetters",
    value: function () {
      var _checkLetters = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(row) {
        var reveal,
            i,
            _keyboard$findKeyDiv,
            letter,
            className,
            _args2 = arguments;
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                reveal = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : true;
                i = 0;
              ...
              case 2:
                ...
                (_keyboard$findKeyDiv = _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.findKeyDiv(letter)) === null || _keyboard$findKeyDiv === void 0 ? void 0 : _keyboard$findKeyDiv.classList.add(className);
    ...
    key: "shakeRow",
    value: function () {
      var _shakeRow = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(row) {
        var toggleClass, i;
    ...
    key: "animateLetter",
    value: function () {
      var _animateLetter = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(letter) {
        var inOut;
    ...
    key: "keyPressed",
    value: function () {
      var _keyPressed = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(key) {
        var _this3 = this;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.t0 = key;
                _context5.next = _context5.t0 === 'enter' ? 4 : _context5.t0 === 'backspace' ? 16 : 18;
                break;
...
var getItem = function getItem(itemKey) {
...
var removeItem = function removeItem(itemKey) {
  if (window.localStorage && window.localStorage.getItem) {
...
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/reset.svg */ "./src/assets/reset.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/chart.svg */ "./src/assets/chart.svg"), __webpack_require__.b);
...
var ___CSS_LOADER_URL_IMPORT_7___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/github.svg */ "./src/assets/github.svg"), __webpack_require__.b);
...
_keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.keyFunction = _puzzle__WEBPACK_IMPORTED_MODULE_1__.puzzle.keyPressed;
(0,_language__WEBPACK_IMPORTED_MODULE_3__.initLanguage)();
_puzzle__WEBPACK_IMPORTED_MODULE_1__.puzzle.checkStoredGame();
})();

/******/ })()
;
//# sourceMappingURL=bundle.0918da39af2735b55984.js.map